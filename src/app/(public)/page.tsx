...
export default function Home() {
  // Hero dinamica da Firestore
  const [heroImage, setHeroImage] = useState<string>("");
  const [heroImagePosition, setHeroImagePosition] =
  ...
  useEffect(() => {
    (async () => {
      ...
      if (snap.exists()) {
        ...
        setHeroImagePosition(d.imagePosition || "center 0px");
          ...
          <div className="relative w-full flex items-center justify-center overflow-hidden pt-hero-landscape md:h-screen md:min-h-screen">
            ...
            <motion.div className="absolute inset-0 z-0" id="hero-bg-parallax">
              <motion.div className="relative w-full h-full overflow-hidden">
                <Image
                  src={heroImage || "/gruppo_lavoratori.jpg"}
                  alt="Sfondo hero"
                  fill
                  priority
            ...
            <div className="relative z-10 flex flex-col items-center justify-center gap-0 sm:gap-4 text-center px-4 ">
              ...
              <motion.div
                ...
                className="mt-10 sm:mt-0 hero-logo-landscape h-[96px] w-[300px] sm:h-[112px] sm:w-[360px] shrink-0"
              >
                <Image
                  src="/logo.png"
                  alt="Logo"
                  ...
                  priority
                  draggable={false}
                  className="mb-0 h-full w-full object-contain drop-shadow-md hero-logo-landscape transform-gpu will-change-transform"
              ...
              <motion.span
                ...
                className="text-xl sm:text-2xl text-white font-bold px-4 py-2 rounded-xl tracking-[0.12em]"
                style={{
                  textShadow:
                    "0 2px 8px rgba(0, 0, 0, 0.7), 0 0px 2px #000000ff, 1px 1px 0 #000000ff, -1px -1px 0 #000000ff",
                }}
                ...
                >
                  <div className="relative w-full lg:w-1/2 h-40 sm:h-56 lg:h-72 rounded-2xl overflow-hidden transition-all duration-300">
                    <Image
                      ...
                      loading={activeMethodStep.priority ? "eager" : undefined}
          ...
          <div className="max-w-7xl mx-auto px-6 space-y-12">
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-[#475569] max-w-3xl mx-auto">
                Promo dedicate su bagni, cucine e riqualificazioni per partire
                subito con il tuo progetto.
              </p>
            </div>
