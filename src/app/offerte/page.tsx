...
const faqs = [
  {
    ...
    answer: "Sì, ogni pacchetto include project manager dedicato, report digitali e coordinamento squadre.",
  },
  {
    question: "Posso personalizzare i materiali?",
    answer: "Selezioniamo marchi premium e possiamo adattare il pacchetto alle tue esigenze estetiche e funzionali.",
  },
  {
    question: "Quanto durano le promozioni?",
    answer: "Le promozioni restano attive fino a esaurimento disponibilità; ti aggiorniamo durante il brief iniziale.",
  },
  {
    question: "Gestite anche pratiche e incentivi?",
    answer: "Curiamo pratiche fiscali e incentivi, affiancandoti nella raccolta documentale e nella gestione ENEA.",
  },
];
  ...
  const fallbackOffers = [
    {
      ...
      descrizione: "Nuove superfici, box doccia frameless e accessoristica premium in 20 giorni.",
      immagine: "/gallery1.jpg",
    },
    {
      id: "fallback-2",
      titolo: "Cucina sartoriale smart",
      descrizione: "Pensili su misura, top tecnico e integrazione domotica completa.",
      immagine: "/gallery2.jpg",
    },
    {
      id: "fallback-3",
      titolo: "Riqualificazione energetica",
      descrizione: "Cappotto, infissi e consulenza incentivi coordinata dal nostro studio.",
    ...
    return (
      ...
      >
        ...
        <div className="flex-1 p-8 space-y-4">
          ...
          <p className="text-lg text-[#475569] leading-relaxed">{offerta.descrizione}</p>
    ...
    <main className="min-h-screen bg-[#f5f6fa] text-[#1a2a4e] font-sans">
      ...
      <section ref={heroRef} className="relative min-h-[40vh] flex items-center justify-center overflow-hidden">
        <motion.div style={{ y: heroParallax }} className="absolute inset-0">
          <Image src="/gallery1.jpg" alt="Offerte MarBel" fill priority className="object-cover object-center" />
        </motion.div>
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-white/85">
            Selezione di pacchetti chiavi in mano per intervenire subito su cucine, bagni e riqualificazioni.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          >
            <p className="text-sm uppercase tracking-[0.4em] text-[#94a3b8]">Pacchetti limitati</p>
            ...
            <p className="text-lg text-[#475569] max-w-3xl mx-auto">
              Materiali premium, timeline definite e un unico project manager dedicato, per attivare il cantiere senza
              sorprese.
            </p>
          </motion.div>
      ...
      <section className="py-24 px-6 bg-[#f5f6fa]">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="space-y-4"
          >
            <p className="text-sm uppercase tracking-[0.4em] text-[#94a3b8]">Promo dedicata</p>
            <h3 className="text-3xl font-extrabold uppercase tracking-wide">
              Cucine e bagni chiavi in mano, tempi certi.
            </h3>
            <p className="text-lg text-[#475569] leading-relaxed">
              Coordinamento fornitori, mockup 3D, direzione lavori certificata: tutto dentro un’unica offerta trasparente.
            </p>
            <a
              href="/preventivo"
          ...
          >
            <Image src="/gallery3.jpg" alt="Promo MarBel" fill className="object-cover" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          >
            <p className="text-sm uppercase tracking-[0.4em] text-[#94a3b8]">Faq</p>
            <h3 className="text-3xl font-extrabold uppercase tracking-wide">Domande frequenti</h3>
          </motion.div>
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span className="text-sm uppercase tracking-[0.3em] font-semibold">{faq.question}</span>
                ...
                >
                  <p className="mt-3 text-[#475569] text-sm leading-relaxed">{faq.answer}</p>
                </motion.div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="relative py-24 px-6 overflow-hidden">
        <motion.div style={{ y: heroParallax }} className="absolute inset-0">
          <Image src="/gallery1.jpg" alt="Contattaci" fill className="object-cover" />
        </motion.div>
        ...
        >
          <p className="text-sm uppercase tracking-[0.4em] text-white/70">Pronto a iniziare?</p>
