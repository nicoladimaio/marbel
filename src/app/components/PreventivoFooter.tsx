...
export default function PreventivoFooter() {
  return (
    <>
      ...
      <section
        className="w-full flex flex-col items-center justify-center py-16 px-0 bg-[url('/sfondo.jpg')] bg-cover bg-center bg-fixed relative"
      ...
      >
        <div className="max-w-2xl w-full mx-auto text-center flex flex-col items-center justify-center relative z-10">
          ...
          <p className="text-white text-lg mb-8 drop-shadow-lg">
            Contattaci ora e ricevi una consulenza personalizzata per il tuo
            progetto.
          </p>
          <Link
            href="/preventivo"
